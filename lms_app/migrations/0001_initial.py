# Generated by Django 4.0.6 on 2022-07-26 22:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('avilable', 'avilable'), ('retal', 'retal'), ('sold', 'sold')], max_length=50, null=True)),
